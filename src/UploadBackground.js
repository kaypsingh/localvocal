...
class UploadBackground extends React.Component {
    ...
    getBackLogic = () => {
        ...
        var roomname = this.props.panelActionRoomname

        var path = "authkey=M2atKiuCGKOo9Mj3&roomname=" + roomname;
        path = this.props.getFormData(path);

        axios.post('https://api.videomeet.in/v3/conference.php/getbglogo', path
            , {
    ...
    render() {
        ...
        return (
            <>
                ...
                <div id="dvBackgroundImage" className="popBox" style={{ display: 'block' }}>
